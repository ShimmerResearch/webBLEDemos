...
1. From the repository root, run `cd shimmer-ble-sdk && npm install && npm run build` to produce the SDK dist files (required the first time, or after any SDK change).
